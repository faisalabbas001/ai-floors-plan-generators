        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-center space-y-6 max-w-lg">
            <h2 className="text-4xl font-bold text-white text-balance">
              Welcome Back to Floor Plan AI
            </h2>
            <p className="text-xl text-white/80">
              Continue designing professional architectural floor plans with AI assistance
            </p>
            <div className="pt-8 space-y-4">
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center">
                  <div className="text-3xl font-bold text-white">50K+</div>
                  <div className="text-sm text-white/60">Floor Plans</div>
                </div>
                <div className="text-center">
